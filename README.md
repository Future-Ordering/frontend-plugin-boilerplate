...
4. Open Future Ordering UI, navigate to /plugins and configure name "myplugin", version "1.0.0". Let config be default value.
...
[developer.futureordering.com](https://developer.futureordering.com/docs/frontend-plugins/plugins-intro)
